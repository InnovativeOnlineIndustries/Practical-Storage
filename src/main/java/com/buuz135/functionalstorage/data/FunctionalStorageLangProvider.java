...
public class FunctionalStorageLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add(FunctionalStorage.COLLECTOR_UPGRADE.get(), WordUtils.capitalize(Registry.ITEM.getKey(FunctionalStorage.COLLECTOR_UPGRADE.get()).getPath().replace('_', ' ').toLowerCase()));
        this.add(FunctionalStorage.PULLING_UPGRADE.get(), WordUtils.capitalize(Registry.ITEM.getKey(FunctionalStorage.PULLING_UPGRADE.get()).getPath().replace('_', ' ').toLowerCase()));
        this.add(FunctionalStorage.PUSHING_UPGRADE.get(), WordUtils.capitalize(Registry.ITEM.getKey(FunctionalStorage.PUSHING_UPGRADE.get()).getPath().replace('_', ' ').toLowerCase()));
        this.add(FunctionalStorage.VOID_UPGRADE.get(), WordUtils.capitalize(Registry.ITEM.getKey(FunctionalStorage.VOID_UPGRADE.get()).getPath().replace('_', ' ').toLowerCase()));
        this.add(FunctionalStorage.REDSTONE_UPGRADE.get(), WordUtils.capitalize(Registry.ITEM.getKey(FunctionalStorage.REDSTONE_UPGRADE.get()).getPath().replace('_', ' ').toLowerCase()));
        this.add(FunctionalStorage.CREATIVE_UPGRADE.get(), WordUtils.capitalize(Registry.ITEM.getKey(FunctionalStorage.CREATIVE_UPGRADE.get()).getPath().replace('_', ' ').toLowerCase()));
